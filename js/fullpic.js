...
// // const ITEMS_COUNT = 26;
// // const CONTAINER = document.querySelector('.big-picture__preview');
// // const ITEM_TEMPLATE = document.querySelector('#big-picture__img');

// // const fill = (n) => {
// //   const fragment = document.createDocumentFragment();
// //   //for (let i = 1; i < n; i++) {
// //   const element = ITEM_TEMPLATE.content.cloneNode(true).querySelector('.big-picture__img');
// //   console.log(element);
// //   const BIG_IMG = element.querySelector('img');
// //   element.setAttribute('id', 2);

// //   BIG_IMG.setAttribute('src', `photos/${2}.jpg`);
...
// // const renderItems = (n) => {
// //   const itemFragment = fill(n);

// //   CONTAINER.textContent = '';
// //   CONTAINER.appendChild(itemFragment);
// //   CONTAINER.addEventListener('Click', clickHandler);
// // }
// // renderItems(ITEMS_COUNT);
